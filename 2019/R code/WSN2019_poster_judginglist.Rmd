...
**WSN 2019 POSTER LIST for JUDGES**
...
This MS Word document was  created with RMarkdown using a report generated in CVENT
 ...
 Attribute     | Meta-Data
---------------|-------------------------------------------|
 Script        | WSN2019_posterjudging_list.Rmd                   |
 Author        | Mairin Deith     |
...
d.tmp <- d[d$student.judging.category != "",]
  ...
  # print everything in order with italics and bold where needed
     cat(paste0(
       ...
       "**",d.tmp$dagger[i],auths,"**","    \n",
         d.tmp$title[i],"    \n",
       paste0("**Category**: ", d.tmp$student.judging.category[i]),
     "   \n", "   \n"))
}
```
